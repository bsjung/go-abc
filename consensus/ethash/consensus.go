...
var (
	FrontierBlockReward           = big.NewInt(5e+10) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward          = big.NewInt(3e+10) // Block reward in wei for successfully mining a block upward from Byzantium
	ConstantinopleBlockReward     = big.NewInt(2e+10) // Block reward in wei for successfully mining a block upward from Constantinople
